...
Public Class Privacy
    ...
    Private Sub Aboutus_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        TextBox1.Font = New Font(pfc.Families(0), 12)
        ...
        Select Case lng
            Case "eng"
                ...
                TextBox1.Text = My.Resources.Privacy_Policy_Eng
                p1 = "Home Button"
                p2 = "World OF Words"
            ...
            Case "per"
                ...
                TextBox1.Text = My.Resources.Privacy_Policy_Per
                p1 = "بازگشت به خانه"
                p2 = "World OF Words"
                p3 = "Think Persian, Learn English"
                p4 = "Copyright © 2022 - 2026 WorldOfWords®. All rights reserved."
            ...
            Case "fra"
                TextBox1.TextAlign = HorizontalAlignment.Left
                TextBox1.Text = My.Resources.Privacy_Policy_Fr
                p1 = "Bouton d'accueil"
                p2 = "World OF Words"
                p3 = "Think Persian, Learn English"
                p4 = "Copyright © 2022 - 2026 WorldOfWords®. All rights reserved."
