...
Public Class Us
    ...
    Private Sub Us_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        Select Case lng
            Case "eng"
                ...
                TextBox1.Text = My.Resources.Resources.Aboutus_Eng

            Case "per"
                TextBox1.TextAlign = HorizontalAlignment.Right
                TextBox1.Text = My.Resources.Resources.Aboutus_Per
                p1 = "بازگشت به خانه"
                p2 = "World OF Words"
                p3 = "Think Persian, Learn English"
                p4 = "Copyright © 2022 - 2026 WorldOfWords®. All rights reserved."
            ...
            Case "fra"
                TextBox1.TextAlign = HorizontalAlignment.Left
                TextBox1.Text = My.Resources.Resources.Aboutus_Fr
                p1 = "Bouton d'accueil"
                p2 = "World OF Words"
                p3 = "Think Persian, Learn English"
                p4 = "Copyright © 2022 - 2026 WorldOfWords®. All rights reserved."
